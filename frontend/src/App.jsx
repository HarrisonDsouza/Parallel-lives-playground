...
export default function App() {
	...
	const getMascotBehavior = () => {
		...
		const randomPosition = () => {
			// For home page, allow both top and bottom positions
			if (path === "/") {
				const positions = [
					"top-right",
					"top-left",
			...
			// For other pages, prefer top positions to avoid blocking content
			const positions = [
				"top-right",
				"top-left",
				"top-right",
		...
		switch (path) {
			case "/":
				return {
					...
					position: randomPosition(), // Now includes both top and bottom positions for home
				};
			case "/editor":
				return {
			...
			default:
				...
				return {
					...
					message: randomMessage(
						isVisitPage ? visitMessages : defaultMessages
					),
	...
	return (
		<div className="app-container">
			...
			<footer className="app-footer">
				<p>
					© 2025 Parallel Lives Playground | Built with React &
					Three.js
				</p>
			</footer>
