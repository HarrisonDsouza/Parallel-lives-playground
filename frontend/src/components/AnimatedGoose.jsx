		...
		>
            ...
            --------------------------- */}
               ...
               C 85 130, 83 120, 78 105 Z"
					...
					/>
					<path
						d="M 58 120 C 53 125, 53 135, 58 140"
						fill="none"
						stroke="#6B5547"
						strokeWidth="0.6"
					/>
					<path
						d="M 63 117 C 58 122, 58 132, 63 137"
						fill="none"
						stroke="#6B5547"
						strokeWidth="0.6"
					/>
					<path
						d="M 68 115 C 63 120, 63 130, 68 135"
						fill="none"
						stroke="#6B5547"
						strokeWidth="0.6"
					/>
            ...
            --------------------------- */}
               ...
               C 115 130, 117 120, 122 105 Z"
					...
					/>
					<path
						d="M 142 120 C 147 125, 147 135, 142 140"
						fill="none"
						stroke="#6B5547"
						strokeWidth="0.6"
					/>
					<path
						d="M 137 117 C 142 122, 142 132, 137 137"
						fill="none"
						stroke="#6B5547"
						strokeWidth="0.6"
					/>
					<path
						d="M 132 115 C 137 120, 137 130, 132 135"
						fill="none"
						stroke="#6B5547"
						strokeWidth="0.6"
					/>
            ...
            --------------------------- */}
				<motion.g
					animate={{
						y:
							currentAnimation.body && currentAnimation.body.y
								? currentAnimation.body.y.map((v) => v * 0.08)
								: [0],
					}}
					transition={currentAnimation.transition}
				>
            ...
            --------------------------- */}
				{(action === "celebrating" ||
					...
					<motion.g
						...
						transition={{
							duration: action === "super_celebrating" ? 0.6 : 1,
							repeat: Infinity,
						}}
					>
						<circle
